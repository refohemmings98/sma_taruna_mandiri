    ...
    <div class="page-wrapper-bottom">
        ...
        <div class="page-prefooter">
            <div class="container">
                <div class="row">
                    <div class="col-md-3 col-sm-6 col-xs-12 footer-block">
                        <h2>Tentang</h2>
                        <p> JL. Raya Pamulang 2 No. 3 Pamulang  
                            Tangerang Selatan,  
                            Banten. 
                            Kode Pos: 15416.    
                            Indonesia.   </p>
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12 footer-block">
                            ...
                            <ul class="social-icons">
                                <li>
                                    <a href="https://www.facebook.com/Sekolah-Taruna-Mandiri-139469492757859:;" data-original-title="facebook" class="facebook"></a>
                                </li>
                                <li>
                                    <a href="https://www.youtube.com/channel/UC5nOGGya4o0wM6DA0dzdO8g/videos" data-original-title="youtube" class="youtube"></a>
                                </li>
                            </ul>
                        </div>
                        <div class="col-md-3 col-sm-6 col-xs-12 footer-block">
                            <h2>kontak kami</h2>
                            <address class="margin-bottom-40"> Phone: (021) 7463-5180
                                <br> Website:
                                <a href="http://sekolahtarunamandiri.sch.id">sekolahtarunamandiri.sch.id</a>
                            </address>
                        </div>
                    </div>
                </div>
            ...
            <div class="page-footer">
                <div class="container"> 2019 &copy; E-Learning SMA Taruna Mandiri By
                    <a target="_blank" href="http://instagram.com/hafsah.refo">Hafsah Refowiana</a> &nbsp;
                </div>
            </div>
